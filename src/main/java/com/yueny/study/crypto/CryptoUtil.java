package com.yueny.study.crypto;
...
public class CryptoUtil {
    ...
    private static final String DEFAULT_SALT = "20212021";
    ...
    public static String encodeSrc(String src) {
        return encodeSrc(src, DEFAULT_SALT);
    }

    /**
     * 加密
     */
    public static String encodeSrc(String src, String salt) {
     ...
     * 解密
     */
    public static String decodeSrc(String target) {
    ...
    public static void main(String[] args) {
        String yuanWenStr = "18090752567";
        String salt = "18067901752";

        String miStr = encodeSrc(yuanWenStr, salt);
        System.out.println("明文：" + yuanWenStr);
        System.out.println("密文：" + miStr);
        System.out.println("密文解密后明文：" + decodeSrc(miStr));

        System.out.println("==================");

        miStr = encode64(salt, yuanWenStr);
        System.out.println("明文：" + yuanWenStr);
        System.out.println("密文：" + miStr);
        System.out.println("密文解密后明文：" + decode64(salt, miStr));
    }
